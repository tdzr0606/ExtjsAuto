 ...
 */
public class CreateSpringBootVO extends CreateBase
{
    ...
    public CreateSpringBootVO(Statement statement, String tableName, String className, String packageName, String filePath,
