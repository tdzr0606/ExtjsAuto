 ...
 */
public class CreateLombokVO extends CreateBase
{
    ...
    public CreateLombokVO(Statement statement, String tableName, String className, String packageName, String filePath,
