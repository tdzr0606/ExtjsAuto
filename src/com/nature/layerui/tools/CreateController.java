...
public class CreateController extends CreateBase
{
	...
	public CreateController(String className, String filePath, String packageName, String projectName, String
			author,String jspPath)
	{
		super.author = author;
	...
	private String createControllerContent()
	{
		...
		sb.append("import ").append(packageName).append(".controller.system.BaseController;").append(Tools
			.lineSeparator);
		...
		sb.append("      */").append(Tools.lineSeparator);
		sb.append("    @RequestMapping(value=\"/wbkj/").append(Tools.smallFirstChar(className)).append
				("/toPage\")").append(Tools.lineSeparator);
		sb.append("    public String toPage()").append(Tools.lineSeparator);
		sb.append("    {").append(Tools.lineSeparator);
		sb.append("       request.setAttribute(\"rightArray\",super.getRoeAndRightByBorderId(request,borderId));")
				.append(Tools.lineSeparator);
		sb.append("       return \"/wbkj/").append(jspPath).append("/").append(Tools.smallFirstChar(className))
				.append("Info_jsp\";").append(Tools.lineSeparator);
		sb.append("    }").append(Tools.lineSeparator);
		sb.append("    /**").append(Tools.lineSeparator);
		...
		sb.append("    @RequestMapping(value = \"/wbkj/").append(Tools.smallFirstChar(className))
				.append("/list\")").append(Tools.lineSeparator);
		...
		sb.append(
				...
				.append(Tools.lineSeparator);
		sb.append(
				"            @RequestParam(value = \"limit\", required = true, defaultValue = \"40\") Integer " +
						"limit,")
				.append(Tools.lineSeparator);
		...
		sb.append("        return ").append(Tools.smallFirstChar(className))
				.append("Service.listPage(page, limit, key);").append(Tools.lineSeparator);
		sb.append("    }").append(Tools.lineSeparator);
		sb.append(Tools.lineSeparator);
		sb.append("    /**").append(Tools.lineSeparator);
		...
		sb.append("     */").append(Tools.lineSeparator);
		sb.append("    @RequestMapping(value = \"/wbkj/").append(Tools.smallFirstChar(className))
				.append("/new\")").append(Tools.lineSeparator);
		sb.append("    @ResponseBody").append(Tools.lineSeparator);
		...
		sb.append("     */").append(Tools.lineSeparator);
		sb.append("    @RequestMapping(value = \"/wbkj/").append(Tools.smallFirstChar(className))
				.append("/modify\")").append(Tools.lineSeparator);
		sb.append("    @ResponseBody").append(Tools.lineSeparator);
		...
		sb.append("    {").append(Tools.lineSeparator);
		sb.append("        return resultBoolWrapper(").append(Tools.smallFirstChar(className))
				.append("Service.deleteByIds(ids.split(\",\")), \"信息删除成功\", \"信息删除失败\", null);").append(Tools
				.lineSeparator);
		sb.append("    }").append(Tools.lineSeparator);
		sb.append(Tools.lineSeparator);
		sb.append("    /**").append(Tools.lineSeparator);
